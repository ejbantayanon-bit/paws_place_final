...
<body>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 min-h-screen">
        ...
        <div id="right-panel" class="lg:col-span-1 p-8 flex flex-col justify-center items-center bg-white shadow-2xl z-10">
            ...
            <button onclick="window.location.href='<?= base_url('store') ?>'" class="w-full mt-8 py-2 text-xs font-bold text-gray-400 hover:text-gray-600 transition uppercase tracking-widest">← Back to Store Selection</button>
    ...
    <script src="<?= base_url('assets/js/customer_login.js') ?>"></script>
</body>
</html>
