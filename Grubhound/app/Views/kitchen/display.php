...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/preparing_serving.css') ?>">
...
<body>
    ...
    <div class="top-bar">
        ...
        <div class="top-bar-right">
            ...
            <a href="<?= base_url('cashier') ?>" class="back-link">← Staff POS</a>
        </div>
    </div>
    ...
    <script src="<?= base_url('assets/js/preparing_serving.js') ?>"></script>
</body>
</html>
