    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 min-h-screen">
        <div class="lg:col-span-3 cafe-context p-0">
            <div class="w-full h-full flex items-stretch">
                <div class="w-full h-full image-placeholder overflow-hidden relative">
                    <img src="<?= base_url('assets/images/Paws place.jpeg') ?>" alt="Cafe" class="object-cover w-full h-full">
        ...
        <div id="right-panel" class="lg:col-span-1 p-8 flex flex-col justify-center items-center bg-white shadow-2xl z-10">
            ...
            <div class="space-y-4 w-full max-w-xs">
                <button onclick="window.location.href='<?= base_url('store') ?>'" class="role-button bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 text-green-800 w-full rounded-lg border-2 border-green-300">
                ...
                <button onclick="window.location.href='<?= base_url('auth/login') ?>'" class="role-button color-maroon hover:bg-red-900 w-full rounded-lg border-transparent">
