...
<head>
    ...
    <script>
        ...
        const STAFF_NAME = '<?= esc($user_name) ?>';
    </script>
</head>
<body>
        ...
        <aside id="main-sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col justify-between shadow-lg z-20 transition-all duration-300">
            ...
            <div class="p-4 border-t border-gray-100">
                <div class="bg-gray-50 p-3 rounded-lg mb-3">
                    ...
                    <p class="font-bold text-gray-800 truncate" id="staff-name"><?= esc($user_name) ?></p>
                </div>
                <a href="<?= base_url('auth/logout') ?>" class="block text-center w-full py-2 bg-red-100 text-red-700 font-bold rounded-lg hover:bg-red-200 transition text-sm">
                    Logout
                </a>
            </div>
        </aside>
