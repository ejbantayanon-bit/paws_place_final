...
<script>
    ...
    const CURRENT_STORE_ID = "<?php echo strtolower(str_replace(' ', '-', $storeName)); ?>";
</script>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <section class="bg-white p-6 flex flex-col h-full border-r border-gray-200 overflow-hidden">
            <header class="mb-4 flex justify-between items-center flex-none">
                <div class="flex items-center gap-4">
                    <button onclick="goBack()" class="flex items-center justify-center w-12 h-12 bg-[#800000] text-white rounded-full shadow-lg transition-all transform hover:scale-110 active:scale-95" title="Back">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            ...
                            <h1 class="text-2xl sm:text-4xl font-black text-[#800000] tracking-tighter uppercase leading-none"><?php echo htmlspecialchars(strtoupper($storeName)); ?></h1>
                        </div>
                ...
                <div class="relative">
                    <button type="button" id="store-dropdown-btn" class="flex items-center gap-2 px-4 py-2 bg-[#800000] hover:bg-red-900 text-white rounded-lg text-sm font-semibold shadow-sm uppercase tracking-tighter transition-all">
                        <span id="current-store-display"><?php echo htmlspecialchars($storeName); ?></span>
    ...
    <script>
        // Notification Logic for Cafeteria Page
